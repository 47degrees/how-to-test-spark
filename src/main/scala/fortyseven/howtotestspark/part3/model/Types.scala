...
object Types {
  ...
  //@newtype case class Manager(value: String)
  //object BackEndManger extends Manager("Pierre Graz")
  //object DataScienceManager extends Manager("Luisa Garcia")
  //object OtherDepartmentsManager extends Manager("Mr. CEO")
  //@newtype case class Department(value: String)
