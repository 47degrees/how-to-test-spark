...
object Combinator {
   ...
   * @param dataFrame      a dataframe that will be subject of the transformations.
   * @param transformation a list containing the transformations to be applied on the dataframe.
   * @return               a dataframe that is the result of applying the transformations to the input dataframe.
   */
  @tailrec
